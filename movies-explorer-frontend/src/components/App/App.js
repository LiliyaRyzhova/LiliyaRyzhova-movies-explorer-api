    ...
    <div className="app">
     <InfoTooltip isOpen={isInfoToolTipNotificationOpen} status={toolTipStatus} onClose={closeAllPopups} />
      <Switch>
        ...
        <Route path="/signup"> <Register onRegister={handleRegister} message={message}/></Route>
        <Route path="/signin"> < Login onLogin={handleLogin} message={message}/> </Route>
        <ProtectedRoute 
        path="/movies"
        loggedIn={loggedIn} 
        component={Movies}
        ...
        <ProtectedRoute 
         ...
         loggedIn={loggedIn} 
          ...
          message={moviesMessage}
          />
        <ProtectedRoute path="/profile" component={Profile} loggedIn={loggedIn} message={message} onLogout={handleLogOute} onUpdateUserData={handleUpdateUserData}/>
